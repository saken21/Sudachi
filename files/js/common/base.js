...
(function(window) {
	...
	function writeJS(fileName,src) {
		...
		document.write('<script src="' + src + fileName + '.js?ver=' + _.VERSION + '" type="text/javascript" charset="UTF-8"></script>');
		return false;
	...
	Get Filled Number
	========================================================================== */
	function getFilledNumber(num,digits) {

	    var result      = num + '';
	    var blankLength = digits - getDigits(num);

	    for (var i = 0; i < blankLength; i++) result = "0" + result;
	
		function getDigits(val) { return (val + '').length; }
	...
	_baseJS.getFilledNumber = getFilledNumber;
